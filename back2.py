...
def main():
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 1:
            ...
            right = {"Wrist" : results.multi_hand_landmarks[0].landmark[0], "Thumb CMC" : results.multi_hand_landmarks[0].landmark[1], \
            ...
            left = {"Wrist" : results.multi_hand_landmarks[1].landmark[0], "Thumb CMC" : results.multi_hand_landmarks[1].landmark[1], \
