...
def SetThreshold(cap):
    ...
    return percentage_yellow * 1 , percentage_yellow * 0.5
...
while True:
    ...
    if percentage_yellow >= upper_yellow_threshold:
        ...
        # cv2.imshow("Yellow Color Detection", res)    # Shows the Seletion, if you want to see it
        cv2.imshow("Yellow Color Detection", frame)    # Shows Normal Video    
