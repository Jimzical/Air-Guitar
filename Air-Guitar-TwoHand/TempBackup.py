...
def DrawBoard(image, AnchorStartPoint,AnchorEndPoint , lines = 4, offset = 0,dynamic = False,log = False , length = 2, thickness = 4):
    '''
    -------------------------------------------------------------
    Draws the board
    -------------------------------------------------------------
    ### Parameters:
        ...
        offset: Offset of the line [int] (Default = 0)
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for i in results.multi_handedness:
                # print(i)
                pass
                # print(i.classification[0].label)

        # if results.multi_hand_landmarks:
        if results.multi_hand_landmarks and len(results.multi_handedness) == 2:  
            # if results.multi_handedness[0].classification[0].label == "Right":  
            #     Rpoint = {"Wrist" : results.multi_hand_landmarks[0].landmark[0] ,"Thumb CMC" : results.multi_hand_landmarks[0].landmark[1], \
            ...
            #     print("Right Hand Index Tip => x: {} y: {} z: {}".format(Rpoint["Index Tip"].x, Rpoint["Index Tip"].y,Rpoint["Index Tip"].z))
            #     print()
                
            # if results.multi_handedness[0].classification[0].label == "Left":  
            #     Lpoint = {"Wrist" : results.multi_hand_landmarks[0].landmark[0] ,"Thumb CMC" : results.multi_hand_landmarks[0].landmark[1], \
            #         "Thumb MCP" : results.multi_hand_landmarks[0].landmark[2], "Thumb IP" : results.multi_hand_landmarks[0].landmark[3], \
            #             "Thumb Tip" : results.multi_hand_landmarks[0].landmark[4], "Index MCP" : results.multi_hand_landmarks[0].landmark[5], \
            #                 "Index PIP" : results.multi_hand_landmarks[0].landmark[6], "Index DIP" : results.multi_hand_landmarks[0].landmark[7], \
            #                     "Index Tip" : results.multi_hand_landmarks[0].landmark[8], "Middle MCP" : results.multi_hand_landmarks[0].landmark[9], \
            ...
            #     print("Left Hand Index Tip => x: {} y: {} z: {}".format(Lpoint["Index Tip"].x, Lpoint["Index Tip"].y,Lpoint["Index Tip"].z))

            # debugz(results=results)

            markHands(image, results, point,mp_drawing,mp_drawing_styles,mp_hands)

            # draw = DrawBoard(image, point["Wrist"], point["Middle MCP"], lines=5, offset=20,log=False , dynamic=False)

            # ContactCheck(image,draw, point["Thumb Tip"],log = False, accuracy = 5)
        
        showImage(image)
        endCode(cap,debug = True)
...
def main():
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 2:
            left = {"Wrist": results.multi_hand_landmarks[0].landmarks[0],"Thumb CMC" : results.multi_hand_landmark[0].landmarks[1] , "Thumb MCP": results.multi_hand_landmarks[0].landmarks[2],"Thumb IP": results.multi_hand_landmarks[0].landmarks[3], "Thumb Tip": results.multi_hand_landmarks[0].landmarks[4],"Index MCP": results.multi_hand_landmarks[0].landmarks[5], \
                    "Index PIP": results.multi_hand_landmarks[0].landmarks[6],"Index DIP": results.multi_hand_landmarks[0].landmarks[7],   \
                    "Index Tip": results.multi_hand_landmarks[0].landmarks[8],"Middle MCP": results.multi_hand_landmarks[0].landmarks[9], \
                    "Middle PIP": results.multi_hand_landmarks[0].landmarks[10],"Middle DIP": results.multi_hand_landmarks[0].landmarks[11], \
                    "Middle Tip": results.multi_hand_landmarks[0].landmarks[12],"Ring MCP": results.multi_hand_landmarks[0].landmarks[13], \
                    "Ring PIP": results.multi_hand_landmarks[0].landmarks[14],"Ring DIP": results.multi_hand_landmarks[0].landmarks[15], \
                    "Ring Tip": results.multi_hand_landmarks[0].landmarks[16],"Pinky MCP": results.multi_hand_landmarks[0].landmarks[17], \
                    "Pinky PIP": results.multi_hand_landmarks[0].landmarks[18],"Pinky DIP": results.multi_hand_landmarks[0].landmarks[19], \
                    "Pinky Tip": results.multi_hand_landmarks[0].landmarks[20]}
            
            right = {"Wrist": results.multi_hand_landmarks[1].landmarks[0],"Thumb CMC" : results.multi_hand_landmark[1].landmarks[1] ,\
                    "Thumb MCP": results.multi_hand_landmarks[1].landmarks[2],"Thumb IP": results.multi_hand_landmarks[1].landmarks[3], \
                    "Thumb Tip": results.multi_hand_landmarks[1].landmarks[4],"Index MCP": results.multi_hand_landmarks[1].landmarks[5], \
                    "Index PIP": results.multi_hand_landmarks[1].landmarks[6],"Index DIP": results.multi_hand_landmarks[1].landmarks[7], \
                    "Index Tip": results.multi_hand_landmarks[1].landmarks[8],"Middle MCP": results.multi_hand_landmarks[1].landmarks[9], \
                    "Middle PIP": results.multi_hand_landmarks[1].landmarks[10],"Middle DIP": results.multi_hand_landmarks[1].landmarks[11], \
                    "Middle Tip": results.multi_hand_landmarks[1].landmarks[12],"Ring MCP": results.multi_hand_landmarks[1].landmarks[13], \
                    "Ring PIP": results.multi_hand_landmarks[1].landmarks[14],"Ring DIP": results.multi_hand_landmarks[1].landmarks[15], \
                    "Ring Tip": results.multi_hand_landmarks[1].landmarks[16],"Pinky MCP": results.multi_hand_landmarks[1].landmarks[17], \
                    "Pinky PIP": results.multi_hand_landmarks[1].landmarks[18],"Pinky DIP": results.multi_hand_landmarks[1].landmarks[19], \
                    "Pinky Tip": results.multi_hand_landmarks[1].landmarks[20]}
        
            # print("Left Hand: ", LeftHand["Wrist"].x, LeftHand["Wrist"].y, LeftHand["Wrist"].z)
            # markHands(image, results, LeftHand,mp_drawing,mp_drawing_styles,mp_hands)
            # markHands(image, results, point,mp_drawing,mp_drawing_styles,mp_hands)
